...
@Component({
  ...
  template: `
    ...
    <p class="text-slate-400 mb-6">Ingresa tus credenciales para continuar</p>
    ...
    <div class="mt-6 text-center">
      <p class="text-sm text-slate-400">
        ¿No tienes cuenta?
        <a routerLink="/auth/register" class="text-violet-400 hover:text-violet-300 font-medium transition">
          Regístrate aquí
        </a>
      </p>
    </div>
